...
parser.add_argument('--test-rgb-list', default="/content/TEVAD/list/ped2-i3d-test.list", help='list of test rgb features ')
parser.add_argument('--gt', default="/content/TEVAD/list/gt-ped2.npy", help='file of ground truth ')
...
parser.add_argument('--pretrained-ckpt', default="/content/ckpt/my_best/ped2-both-text_agg-add-1-1-extra_loss-755-4869-i3d.pkl", help='ckpt for pretrained model')
